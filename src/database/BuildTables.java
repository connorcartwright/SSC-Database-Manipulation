...
public class BuildTables {
	...
	private String createMarks = "CREATE TABLE Marks (studentID int REFERENCES Student ON DELETE CASCADE, moduleID int REFERENCES Module ON DELETE CASCADE, year date, typeID int REFERENCES Types ON DELETE CASCADE, mark smallint CHECK (mark BETWEEN 0 AND 100) NOT NULL, notes varchar(200));";
	...
	private String createStudent = "CREATE TABLE Student (studentID int PRIMARY KEY, titleID int REFERENCES Titles ON DELETE CASCADE, forename varchar(30) NOT NULL, familyName varchar(30) NOT NULL, dateOfBirth date);";
